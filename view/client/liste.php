                    ...
                    <table class="table">
                        ...
                        foreach ($client as $key => $value)
                        {
                            echo "<tr>
                                    ...
                                    <td>$value[3]</td>
                                    <td>    
                                        <a href='clientController?edit=$value[0]' class='btn-success'>Edit</a>
                                        <a href='clientController?delete=$value[0]' class='btn-danger'>Delete<a/>
                                    </td>
                                  </tr>";
                        }
                        ?>
                ...
                <div class="panel-body">
                    <form action="clientController" method="POST">
                        <div class="form-group">
                            <label class="control-label" for="nomC">Nom</label>
                        ...
                        <div class="form-group">
                            <input class="btn-success" type="submit" name="ajouter" id="ajouter" value="ajouter"/>
