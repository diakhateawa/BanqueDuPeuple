      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Banque du peuples:</h6>
            <a class="collapse-item" href="clients">Clients</a>
            <a class="collapse-item" href="comptes">Comptes</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Awa DIAKHATE</span>
            ...
            <table class="table">
                ...
                foreach ($compte as $key => $value)
                {
                    echo "<tr>
                                ...
                                <td>$value[3]</td>
                                <td>    
                                    <a href='compteController?edit=$value[0]' class='btn-success'>Edit</a>
                                    <a href='compteController?delete=$value[0]' class='btn-danger'>Delete<a/>
                                </td>
                        </tr>";
                }
                ?>
        ...
        <div class="panel-body">
            <form action="compteController" method="POST">
                <div class="form-group">
                    <label class="control-label" for="numeroCompte">numero du compte</label>
                    <input class="form-control" type="text" name="numerocompte" id="numeroCompte"/>
                </div>
                <div class="form-group">
                    <label class="control-label" for="number">solde</label>
                    <input class="form-control" type="number" name="solde" id="number"/>
                </div>
                <div class="form-group">
                    <label class="control-label" for="Client">Clients</label>
                    <select class="form-control" type="idC" name="idC" id="idC">
                ...
                <div class="form-group">
                    <input class="btn-success" type="submit" name="ajouter" id="ajouter" value="envoyer"/>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; @Evachou 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
